...
/*
 * Class:     com_stormdzh_lame4android_Lame
 * Method:    close
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_stormdzh_lame4android_Lame_init(
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_stormdzh_lame4android_Lame_close(
 ...
 * Signature: ([S[SI[B)I
 */
JNIEXPORT jint JNICALL Java_com_stormdzh_lame4android_Lame_encode(
 ...
 * Signature: ([B)I
 */
JNIEXPORT jint JNICALL Java_com_stormdzh_lame4android_Lame_flush(
 ...
 */
JNIEXPORT jstring JNICALL Java_com_stormdzh_lame4android_Lame_getLameVersion(JNIEnv *env, jclass cls) {
...
JNIEXPORT void JNICALL Java_com_stormdzh_lame4android_Lame_setRawBigEndian(JNIEnv *env, jclass cls,
 ...
 */
JNIEXPORT void JNICALL Java_com_stormdzh_lame4android_Lame_encodeFile(JNIEnv *env, jclass cls,
